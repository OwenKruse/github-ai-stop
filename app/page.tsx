          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center space-y-6">
              ...
              >
                ...
                <span>
                  Now protecting <span className="text-foreground font-medium">12,000+</span> repositories
                </span>
              </motion.div>
        ...
        <section className="relative py-20 border-t border-border">
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-0 md:divide-x divide-border">
              {[
                { value: "2.4M", suffix: "+", label: "Pull requests analyzed", delay: 0 },
                { value: "340K", suffix: "", label: "Spam PRs blocked", delay: 0.15 },
                { value: "99.2", suffix: "%", label: "Detection accuracy", delay: 0.3 },
              ].map((stat) => (
                <AnimatedSection
                  key={stat.label}
                  delay={stat.delay}
